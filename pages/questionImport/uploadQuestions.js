...
import PreviewCSV from "@components/uploadCSV/PreviewCSV";

export function UploadQuestions() {
  return (
    <div className="bs" style={{ overflow: "auto" }}>
      <DetailPageHeader style={{ overflow: "auto" }} />
      <StyledContainer>
...
export async function getStaticProps() {
  const { BODY, HEAD } = await getPageFromWebflow("/question-import-preview");
